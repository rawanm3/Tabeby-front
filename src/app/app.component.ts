  ...
  doctors = [
    {
      ...
      slots: [
        ...
        {
          label: 'Tomorrow',
          times: [{ time: 'No Available Appointments', available: false }],
        },
        {
          label: 'Wed 08/20',
          times: [
    ...
    ...Array.from({ length: 27 }).map((_, i) => ({
      name: `Dr. Female ${i + 1}`,
      title:
        i % 2 === 0 ? 'Professor of Pediatrics' : 'Lecturer of Dermatology',
      rating: 4 + (i % 2) * 0.5,
      ...
      slots: [
        {
          ...
          times:
            i % 4 === 0
              ? [{ time: 'No Available Appointments', available: false }]
              : [
