...
this.roleSpecificForm = this.fb.group({
 ...
 // filepath: c:\Users\lenovo\Desktop\New folder (2)\Tabeby-front\Tabeby-front\Tabeby\src\app\components\register\register.component.ts
nextStep() {
  if (this.isCurrentStepValid()) {
    this.clearMessages();
    this.currentStep++;
  ...
  //     case 2: return this.roleForm.valid;
  //     case 3: return this.roleSpecificForm.valid;
...
//     if (this.roleForm.get('role')?.value === 'doctor' || this.roleForm.get('role')?.value === 'nurse') {
//       return this.roleSpecificForm.valid;
//     }
//     return true;
//   }
//   return true;
...
removeFile() {
  ...
  // // توجيه لصفحة verify-otp ومعاها الايميل
